...
@Component({
    selector: 'app-news-button-save',
    templateUrl: './button-save.component.html',
})
export class ButtonSaveComponent implements OnInit, OnDestroy {
    ...
    @Input() keenIcon = 'directbox-default';
    @Input() keenIconClass = 'fs-4 text-light';
