...
export type FederationAppInitProps = {
    ...
    updateLocale?: (moduleLocaleKey: string, locale: Record<string, string>) => void,
    ...
    updateResponseStatus?: (status: StatusResponseEnum, callBackFunc?: Function) => void,
    showFileManagerDialog: (data: Partial<FileManagerSettingParams>, callback?: (files?: ImageResponseType[]) => void) => void,
    ...
    signalR: {
        ...
        onProcess: (method: string, uniqueKey: string, func: (data: SignalMessageResponse) => void) => void,
