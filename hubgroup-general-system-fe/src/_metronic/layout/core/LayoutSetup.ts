...
export function getEmptyCssClasses() {
    return {
        header: [] as string[],
        headerContainer: [] as string[],
        headerMobile: [] as string[],
        headerMenu: [] as string[],
        aside: [] as string[],
        asideMenu: [] as string[],
        asideToggle: [] as string[],
        toolbar: [] as string[],
        toolbarContainer: [] as string[],
        content: [] as string[],
        contentContainer: [] as string[],
        footerContainer: [] as string[],
        sidebar: [] as string[],
        pageTitle: [] as string[],
    };
}
